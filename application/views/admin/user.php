          ...
          for (const item of res.data) {
            let status = '';
              if (item.status == 'Nonaktif') {
                status = '<span class="badge bg-warning">Nonaktif</span>';
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="text-center">
                                      <a href="<?php echo base_url(); ?>admin/user/view_edit/${item.id}"><button type="button" class="btn btn-shadow btn-sm btn-info"><i class="fas fa-pencil-alt"></i></button></a>
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header d-flex flex-wrap gap-2 justify-content-between align-items-center pt-3 pb-3">
          ...
          <a href="<?php echo base_url(); ?>admin/user/view_tambah"><button type="button"
