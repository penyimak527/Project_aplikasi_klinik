<script type="text/javascript">
  ...
  function edit(e) {
    ...
    $.ajax({
      url: '<?php echo base_url('admin/level/edit') ?>',
      method: 'POST',
        ...
        <div class="card-body">
          <div class="general-label">
            <form id="form_edit">
              ...
              <div class="mb-3 row">
                <label for="edit_contoh" class="col-sm-2 col-form-label">Nama Level</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama" value="<?php echo $row['nama_level']; ?>"
                    id="nama" placeholder="Nama Level" autocomplete="off" required>
                </div>
              </div>
              <div class="row">
