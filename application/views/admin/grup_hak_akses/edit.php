                ...
                <div class="float-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a
                                href="<?php echo base_url(); ?>admin/grup_hak_akses"><?php echo $title; ?></a></li>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_grup" id="nama_grup"
                                        value="<?php echo $row['nama_grup_hak_akses']; ?>" required autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10 ms-auto">
                                    ...
                                    <a href="<?php echo base_url(); ?>admin/grup_hak_akses"><button type="button"
