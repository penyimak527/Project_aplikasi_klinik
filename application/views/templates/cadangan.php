    ...
    <div class="leftbar-tab-menu">
            ...
            <div class="main-icon-menu-body">
                <div class="position-reletive h-100" data-simplebar style="overflow-x: hidden;">
                    <ul class="nav nav-tabs" role="tablist" id="tab-menu">
                        ...
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Kepegawaian"
                            data-bs-trigger="hover">
                            <a href="#menu_kepegawaian" id="kepegawaian-tab" class="nav-link">
                                <i class="ti ti-users menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Resepsionis"
                            data-bs-trigger="hover">
                            <a href="#menu_resepsionis" id="resepsionis-tab" class="nav-link">
                                <i class="ti ti-bell menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Antrian"
                            data-bs-trigger="hover">
                            <a href="#menu_antrian" id="antrian-tab" class="nav-link">
                                <i class="ti ti-ticket menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Poli"
                            data-bs-trigger="hover">
                            <a href="#menu_poli" id="poli-tab" class="nav-link">
                                <i class="ti ti-building-hospital menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Transaksi"
                            data-bs-trigger="hover">
                            <a href="#menu_transaksi" id="transaksi-tab" class="nav-link">
                                <i class="ti ti-shopping-cart menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Keuangan"
                            data-bs-trigger="hover">
                            <a href="#menu_keuangan" id="keuangan-tab" class="nav-link">
                                <i class="ti ti-report-money menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Admin"
                            data-bs-trigger="hover">
                            <a href="#menu_admin" id="admin-tab" class="nav-link">
                                <i class="ti ti-crown menu-icon"></i>
                            </a><!--end nav-link-->
                        </li><!--end nav-item-->
                    </ul><!--end nav-->
                </div><!--end /div-->
        ...
        <div class="main-menu-inner">
            ...
            <div class="menu-body navbar-vertical tab-content" data-simplebar>
                <div id="menu_dashboard" class="main-icon-menu-pane tab-pane" role="tabpanel"
                ...
                <div id="menu_master_data" class="main-icon-menu-pane tab-pane" role="tabpanel"
                    aria-labelledby="master-data-tab">
                    <div class="title-box">
                ...
                <div id="menu_kepegawaian" class="main-icon-menu-pane tab-pane" role="tabpanel"
                ...
                <div id="menu_resepsionis" class="main-icon-menu-pane tab-pane" role="tabpanel"
                    aria-labelledby="resepsionis-tab">
                    <div class="title-box">
                ...
                <div id="menu_antrian" class="main-icon-menu-pane tab-pane" role="tabpanel"
                ...
                <div id="menu_transaksi" class="main-icon-menu-pane tab-pane" role="tabpanel"
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url() ?>transaksi/pembayaran/riwayat">Riwayat
                                Pembayaran</a>
                        </li><!--end nav-item-->
                    </ul><!--end nav-->
                </div><!-- end -->
                <div id="menu_keuangan" class="main-icon-menu-pane tab-pane" role="tabpanel"
                    aria-labelledby="keuangan-tab">
                    <div class="title-box">
                ...
                <div id="menu_admin" class="main-icon-menu-pane tab-pane" role="tabpanel" aria-labelledby="admin-tab">
                    <div class="title-box">
                        <h6 class="menu-title">Admin</h6>
                    </div>
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url() ?>admin/level">Level</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url() ?>admin/user">User</a>
                        </li><!--end nav-item-->
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url() ?>admin/hak_akses">Hak Akses</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url() ?>admin/grup_hak_akses">Grup Hak Akses</a>
                        </li>
                    </ul><!--end nav-->
                </div><!-- end -->
            </div>
                ...
                <li class="dropdown">
                    <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <small
                                    class="d-none d-md-block font-11"><?php echo $this->session->userdata('nama_level') ?></small>
                                <span
                                    class="d-none d-md-block fw-semibold font-12"><?php echo $this->session->userdata('username') ?>
