                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="text-center">
                                      <a href="<?php echo base_url(); ?>kepegawaian/dokter/kalender/${item.id}"><button type="button" class="btn btn-shadow btn-sm btn-warning"><i class="mdi mdi-calendar
"></i></button></a>         
                                  </div>
                              </td>
                          </tr>
          ...
          <div class="row mb-3">
            <div class="col-sm-3">
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="cari" placeholder="Cari Nama Dokter/Poli" autocomplete="off">
              </div>
            </div>
          </div>
