<script type="text/javascript">
  ...
  function tambah(e) {
    ...
    $.ajax({
      url: '<?php echo base_url('master_data/diagnosa/tambah') ?>',
      method: 'POST',
        ...
        <div class="card-body">
          <div class="general-label">
            <form id="form_tambah">
              <!-- inputan start -->
              <div class="mb-3 row">
                <label for="tambah_contoh" class="col-sm-2 col-form-label">Nama Diagnosa</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama_diag" id="nama_diag" placeholder="Nama diagnosa"
