<script type="text/javascript">
  function edit(e) {
      ...
      $.ajax({
          url : '<?php echo base_url('master_data/satuan/edit') ?>',
          method : 'POST',
          ...
          <div class="card-body">
            <div class="general-label">
              <form id="form_edit">
                ...
                <div class="mb-3 row">
                  <label for="edit_satuan" class="col-sm-2 col-form-label">satuan</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" name="satuan" value="<?php echo $row['nama_satuan']; ?>" id="edit_satuan" placeholder="Input satuan">
                  </div>
                </div>
                <div class="row">
