    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header d-flex flex-wrap gap-2 justify-content-between align-items-center pt-3 pb-3">
          ...
          <a href="<?php echo base_url(); ?>keuangan/pengeluaran/view_tambah"><button type="button"
          ...
          <div class="row mb-3">
            <div class="col-sm-3">
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="cari" placeholder="Cari Jenis Biaya/Keterangan" autocomplete="off">
              </div>
            </div>
          </div>
