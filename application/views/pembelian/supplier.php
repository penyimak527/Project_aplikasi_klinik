<script type="text/javascript">
  ...
  function get_data() {
      ...
      $.ajax({
          url : '<?php echo base_url(); ?>pembelian/supplier/result_data',
          data : {cari},
          type : "POST",
          dataType :  "json",
          beforeSend : () => {
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="text-center ">
                                      <a href="<?php echo base_url(); ?>pembelian/supplier/view_edit/${item.id}"><button type="button" class="btn btn-shadow btn-sm btn-info "><i class="fas fa-pencil-alt"></i></button></a>
  ...
  function hapus(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
              url : '<?php echo base_url(); ?>pembelian/supplier/hapus',
              method : 'POST',
              data : {id},
              dataType : 'json',
              beforeSend: function () {
    ...
    <div class="col-lg-12">
      <div class="card">
          <div class="card-header d-flex flex-wrap gap-2 justify-content-between align-items-center pt-3 pb-3">
              ...
              <a href="<?php echo base_url(); ?>pembelian/supplier/view_tambah"><button type="button" class="btn btn-success"><i class="fas fa-plus"></i> Tambah</button></a>
          </div>
          <div class="card-body">
            <div class="row mb-3">
              <div class="col-sm-3">
